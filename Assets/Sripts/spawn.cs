...
public class spawn : MonoBehaviour
{
    ...
    public static int PlatformCH = 30;
    public static int CircleCH = 30;
    public static int TriangleCH = 30;
    ...
    private void Start()
    {
        CircleCH = PlayerPrefs.GetInt("CircleCH", CircleCH);
        TriangleCH = PlayerPrefs.GetInt("triangle", TriangleCH);
        PlatformCH = PlayerPrefs.GetInt("PlatformCH", PlatformCH);
    }

    private void Update()
    {
        PlayerPrefs.SetInt("triangle", TriangleCH);
        PlayerPrefs.SetInt("PlatformCH", PlatformCH);
        PlayerPrefs.SetInt("CircleCH", CircleCH);
